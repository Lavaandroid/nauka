...
Widget build(BuildContext context){ // build context jest zawarty w material design, context specjalny objekt ktory flutter bedzie wywolywany przez fluttera
  ...
  var pytania=[         //[] zawiera liste, w tym przypadku pytan
    ...
    Map('tekstPytan': 'Jaki jest Twoj ulubiony kolor', //nie jest lista, ale kolekcja kluczy wartosci, pierwsza czesc to klucz, druga wartosc
        'odpowiedzi': ['Czarny', 'Czerwony', 'Zielony', 'Bialy'])
    ,
    Map('tekstPytan': 'Jakie jest Twoje ulubione zwierzątko',
    'odpowiedzi': ['Pies', 'Kot', 'Zebra', 'Królik']
    )
    ,
    Map('tekstPytan': 'W jakim jezyku jest ta aplikacja'),
       Map( 'odpowiedzi': ['Java', 'c++', 'Kotlin', 'Dart']
    )
  ...
  Column(     //zawiera liste widgetow, bo inaczej nie mozna umiescic kilku jesli chce, zeby byly w rzedzie to uzywam row
    children: [
      ...
      Pytanie(
        pytania[_indekspytan] ['tekstPytan'],//pytania.elementAt(0), //wyswietli pierwsze pytanie z listy
      ),
